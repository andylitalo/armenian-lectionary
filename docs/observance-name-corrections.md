...
**108 of those 518 are a known loose end, not a settled exclusion.** Four days a year — the
...
cycle showing through a day count, and the argument that splits the other 1,455 applies to
