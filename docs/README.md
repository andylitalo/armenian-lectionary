...
| [`observance-names-2026.tsv`](observance-names-2026.tsv) · [`observance-names-2027.tsv`](observance-names-2027.tsv) | generated by [`dev/observance_year_table.py`](../dev/observance_year_table.py) | What every day of the year is called, and by which catalog id — the ids of a day in order, positionally aligned with the English and Armenian they stand for. A reviewing artifact for the id contract; nothing at runtime reads it. |
