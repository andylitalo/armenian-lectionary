...
_RETIRED_IDS = {
    ...
    # Renamed pre-release, same carve-out as above -- verified absent from the
    # `observance_catalog.json` shipped in the v1.3.0 PyPI release (`git show
    # v1.3.0:armenian_lectionary/data/observance_catalog.json`), so no consumer can have
    # persisted them. All eleven were minted after v1.3.0 shipped, on main or an unmerged
    # branch, and never reached a tagged release.
    "james_nisibis_day_1": "renamed to james_nisibis_fast_day_1, matching the sibling "
        "cross_varag_fast_day_* / illuminator_fast_day_* naming",
    "james_nisibis_day_2": "renamed to james_nisibis_fast_day_2",
    "james_nisibis_day_3": "renamed to james_nisibis_fast_day_3",
    "james_nisibis_day_4": "renamed to james_nisibis_fast_day_4",
    "james_nisibis_day_5": "renamed to james_nisibis_fast_day_5",
    "cross_varag_day_1": "renamed to cross_varag_fast_day_1, matching the sibling "
        "james_nisibis_fast_day_* / illuminator_fast_day_* naming",
    "cross_varag_day_2": "renamed to cross_varag_fast_day_2",
    "cross_varag_day_3": "renamed to cross_varag_fast_day_3",
    "cross_varag_day_4": "renamed to cross_varag_fast_day_4",
    "cross_varag_day_5": "renamed to cross_varag_fast_day_5",
    "discovery_of_the_belt_of_the_holy_mother_of_god": "renamed to discovery_of_the_belt, "
        "dropping the redundant repetition of the observance's own subject from its id",
    # Renamed for naming-consistency cleanup (id/text drifted from the observance -- a
    # missing/incomplete "of", a truncated saint list, a wrong season on a day-count
    # label, etc). All 97 were present in the v1.3.0 catalog, so by the letter of the
    # rule above they'd need deprecation rather than renaming -- but the maintainer
    # confirmed these ids have not actually been served to/persisted by any real client
    # yet, so a straight rename (not a deprecate-and-remint) is safe here. Declared
    # anyway, for the same audit-trail reason as every other entry in this table.
    "abgar_the_witness_and": "renamed to abgar_the_witness_and_king",
    "andrew_the_general_and": "renamed to andrew_the_general_and_martyrs",
    "apostles_thomas_james_and": "renamed to apostles_thomas_james_simon",
    "appearance_of_the_holy": "renamed to appearance_of_the_holy_cross",
    "athenogenes_the_bishop_and": "renamed to athenogenes_the_bishop_disciples_martyrs",
    "basil_the_great_and": "renamed to basil_gregory_sylvester_ephrem",
    "children_of_bethlehem_sts": "renamed to children_of_bethlehem",
    "clement_the_bishop_of": "renamed to clement_and_pancratius",
    "commemoration_of_150_fathers": "renamed to 150_fathers_constantinople",
    "commemoration_of_200_fathers": "renamed to 200_fathers_ephesus",
    "commemoration_of_318_fathers": "renamed to 318_fathers_nicea",
    "constantine_the_emperor_and": "renamed to constantine_and_helen",
    "cyprian_the_bishop_the": "renamed to cyprian_martyrs_and_virgins",
    "cyril_of_jerusalem_cyril": "renamed to cyril_of_jerusalem_cyril_and_anna",
    "david_of_dvin_and": "renamed to david_of_dvin_and_martyrs",
    "demetrios_the_martyr_and": "renamed to demetrios_the_martyr_and_basil",
    "dionysius_the_areopagite_and": "renamed to dionysius_the_areopagite_and_apostles",
    "discovery_of_relics_of": "renamed to discovery_of_relics_of_st_grigoris",
    "discovery_of_the_holy": "renamed to discovery_of_the_holy_cross",
    "eugenia_the_virgin_her": "renamed to eugenia_the_virgin_and_family",
    "exaltation_of_the_holy": "renamed to exaltation_of_the_holy_cross",
    "fathers_sts_athanasius_and": "renamed to fathers_athanasius_and_cyril",
    "feast_of_all_sts": "renamed to feast_of_all_saints",
    "feast_of_dedication_of": "renamed to feast_of_dedication_of_etchmiadzin",
    "feast_of_discovery_of": "renamed to feast_of_st_gregory_relics",
    "feast_of_holy_church": "renamed to feast_of_holy_church_for_dedication_of_holy_cross",
    "feast_of_naming_of": "renamed to feast_of_naming_of_our_lord",
    "feast_of_the_birth": "renamed to feast_of_the_birth_of_st_mary",
    "feast_of_the_conception": "renamed to feast_of_the_conception_of_st_mary",
    "feast_of_the_discovery": "renamed to feast_of_the_discovery_of_st_mary_box",
    "feast_of_the_holy": "renamed to feast_of_the_holy_church",
    "fifth_sunday": "renamed to fifth_sunday_of_eastertide",
    "forty_eighth_day_of": "renamed to forty_eighth_day_of_eastertide",
    "forty_fifth_day_of": "renamed to forty_fifth_day_of_eastertide",
    "forty_first_day_of": "renamed to forty_first_day_of_eastertide",
    "forty_fourth_day_of": "renamed to forty_fourth_day_of_eastertide",
    "forty_ninth_day_of": "renamed to forty_ninth_day_of_eastertide",
    "forty_second_day_of": "renamed to forty_second_day_of_eastertide",
    "forty_seventh_day_of": "renamed to forty_seventh_day_of_eastertide",
    "forty_sixth_day_of": "renamed to forty_sixth_day_of_eastertide",
    "gennaro_the_bishop_and": "renamed to gennaro_the_bishop_and_mercurius",
    "gregory_and_nicholas_the": "renamed to gregory_and_nicholas_wonderworkers",
    "gregory_the_illuminator_s": "renamed to gregory_the_illuminator_descent",
    "gregory_the_wonderworker_nicholas": "renamed to gregory_the_wonderworker",
    "james_the_apostle_and": "renamed to james_and_john",
    "john_the_patriarch_of": "renamed to john_the_patriarch_of_jerusalem",
    "menas_hermogenes_eugraphus_and": "renamed to menas_hermogenes_eugraphus_and_poor_men",
    "nativity_and_theophany_of": "renamed to nativity_and_theophany",
    "patriarchs_barlaam_anthimus_and": "renamed to patriarchs_barlaam_anthimus_irenaeus",
    "pentecost_fiftieth_day_of": "renamed to pentecost",
    "peter_and_paul_the": "renamed to peter_and_paul_apostles",
    "phocas_the_patriarch_and": "renamed to phocas_and_irenaeus",
    "presentation_of_the_holy": "renamed to presentation_of_the_holy_mother",
    "prophet_daniel_and_his": "renamed to prophet_daniel_and_companions",
    "prophets_ezekiel_ezra_and": "renamed to prophets_ezekiel_ezra_zachariah",
    "remembrance_of_the_armenian": "renamed to remembrance_of_the_armenian_genocide",
    "remembrance_of_the_last": "renamed to last_supper",
    "remembrance_of_the_old": "renamed to remembrance_of_the_old_ark",
    "remembrance_of_the_passion": "renamed to passion_crucifixion_burial",
    "remembrance_of_the_prophet": "renamed to remembrance_of_the_prophet_jonah",
    "remembrance_of_the_raising": "renamed to lazarus",
    "remembrance_of_the_ten": "renamed to ten_virgins",
    "saintly_princes_sahak_and": "renamed to saintly_princes_sahak_and_hamazasp",
    "sargis": "renamed to sarkis",
    "severianus_of_sebastia_and": "renamed to severianus_of_sebastia_babylas_disciples",
    "sophia_and_her_three": "renamed to sophia_and_her_three_daughters",
    "stephen_of_oulnia_and": "renamed to stephen_of_oulnia_and_martyrs",
    "sukias": "renamed to sukiasian",
    "thaddeus_apostle_of_armenia": "renamed to thaddeus_and_sandoukht",
    "theodoret_the_priest_of": "renamed to theodoret_the_priest_of_antioch",
    "theodotus_of_galatia_and": "renamed to theodotus_of_galatia",
    "theopemptus_the_bishop_of": "renamed to theopemptus_the_bishop_of_nicomedia",
    "third_sunday_sunday_of": "renamed to third_sunday_of_eastertide",
    "thirty_eighth_day_of": "renamed to thirty_eighth_day_of_eastertide",
    "thirty_fifth_day_of": "renamed to thirty_fifth_day_of_eastertide",
    "thirty_first_day_of": "renamed to thirty_first_day_of_eastertide",
    "thirty_fourth_day_of": "renamed to thirty_fourth_day_of_eastertide",
    "thirty_ninth_day_of": "renamed to thirty_ninth_day_of_eastertide",
    "thirty_second_day_of": "renamed to thirty_second_day_of_eastertide",
    "thirty_seventh_day_of": "renamed to thirty_seventh_day_of_eastertide",
    "thirty_sixth_day_of": "renamed to thirty_sixth_day_of_great_lent",
    "thirty_third_day_of": "renamed to thirty_third_day_of_eastertide",
    "translators_sts_sahak_and": "renamed to translators_sahak_and_mesrop",
    "twelve_holy_apostles_of": "renamed to twelve_apostles_and_paul",
    "twelve_holy_doctors_of": "renamed to twelve_holy_doctors_of_church",
    "twenty_eighth_day_of": "renamed to twenty_eighth_day_of_eastertide",
    "twenty_fifth_day_of": "renamed to twenty_fifth_day_of_eastertide",
    "twenty_first_day_of": "renamed to twenty_first_day_of_eastertide",
    "twenty_fourth_day_of": "renamed to twenty_fourth_day_of_eastertide",
    "twenty_ninth_day_of": "renamed to twenty_ninth_day_of_great_lent",
    "twenty_second_day_of": "renamed to twenty_second_day_of_great_lent",
    "twenty_seventh_day_of": "renamed to twenty_seventh_day_of_eastertide",
    "twenty_sixth_day_of": "renamed to twenty_sixth_day_of_eastertide",
    "twenty_third_day_of": "renamed to twenty_third_day_of_eastertide",
    "vardan_the_general_and": "renamed to vartan_the_general",
    "virgins_febronia_mariana_and": "renamed to virgins_febronia_mariana_and_shoushan",
    "virgins_thecla_barbara_and": "renamed to virgins_thecla_barbara_and_pelagia",
    "cornelius_the_centurion_simeon_no_title": "merged into cornelius_the_centurion_simeon -- same observance, the source just omitted Simeon's 'Relative of Christ' title on this spelling; approved_hy was already identical",
}
