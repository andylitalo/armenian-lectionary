...
|---|---|---|---|
| calendar position — "Fourth Sunday after Nativity", "Sixth day of the Fast of Nativity", "Third day of the Fast of St. Gregory the Illuminator", "Second day of the Fast of Prophet Elijah", "First day of the Fast of St. James the bishop of Nisibis", "Fast day" | `engine._position_label` | head | `dev/verify_position_labels.py` |
